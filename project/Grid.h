...
class Grid
{
	...
	bool endGame;	
	// A boolean indicating if the Game is ended or not (a player reaches the end cell of the grid or not)
...
public:
	...
	void CountNumber(); //counts number of ladders, snakes, and cards
	...
	// Prints an error message on statusbar, Waits for mouse click then clears statusbar
	bool ValidateLadder(CellPosition start, CellPosition end);
									    // We added this function once here because it is used many times by other classes

	bool ValidateSnake(CellPosition start, CellPosition end);

	void SaveAll(ofstream& OutFile, TYPE);
	void StartNewGame();
